...
def back_propagation(learning_rate,
                     classes_element,
                     hidden_layer_result_with_bias,
                     input_element,
                     output_layer_result,
                     w_hidden_layer,
                     w_output_layer):
    ...
    print("mean_error")
    print(np.mean(errors_output_layer))
...
def feed_forward(classes_element, input_element, w_hidden_layer, w_output_layer):
    print("input_element")
    print(input_element)
    ...
    return hidden_layer_result_with_bias, output_layer_result
...
def main():
    ...
    for input_element, classes_element in itertools.zip_longest(inputs, classes):
        hidden_layer_result_with_bias, output_layer_result = feed_forward(classes_element,
                                                                          input_element,
                                                                          w_hidden_layer,
                                                                          w_output_layer)

        w_hidden_layer, w_output_layer = back_propagation(LEARNING_RATE,
                                                          classes_element,
                                                          hidden_layer_result_with_bias,
                                                          input_element,
                                                          output_layer_result,
